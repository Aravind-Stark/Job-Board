...
class JobSeekerServiceImplTest {
    ...
    /**
     * Method under test: {@link JobSeekerServiceImpl#createJobSeeker(JobSeekerRegisterDTO)}
     */
    @Test
    void testCreateJobSeeker() throws Exception {
        ...
        assertSame(jobSeeker2, jobSeekerServiceImpl
                .createJobSeeker(new JobSeekerRegisterDTO("Jane", "Doe", "jane.doe@example.org", "iloveyou", "Skill")));
